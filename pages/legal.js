...
export default function Legal() {
  ...
  return (
    <>
      <Head>
        <title>Terms & Privacy Policy - Perfect Swing</title>
        <meta
          name="description"
          content="Perfect Swing Terms & Privacy Policy - Legal information for our AI tennis coaching app."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />

        {/* Open Graph meta tags */}
        <meta property="og:title" content="Terms & Privacy Policy - Perfect Swing" />
        <meta
          property="og:description"
          content="Perfect Swing Terms & Privacy Policy - Legal information for our AI tennis coaching app."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://perfectswing.vercel.app/legal" />
      </Head>
          ...
          <div className={styles.content}>
            ...
            {activeTab === "terms" && (
              <div className={styles.tabContent}>
                ...
                <p>
                  These terms and conditions apply to the Perfect Swing app (hereby referred to as "Application") for mobile devices that was created by Park Jinhong (hereby referred to as "Service Provider") as a Freemium service.
                </p>
                ...
                <section className={styles.section}>
                  <h2 className={styles.sectionTitle}>Service Availability and Network Usage</h2>
                  <p>
                ...
                <section className={styles.section}>
                  <h2 className={styles.sectionTitle}>Service Updates and Liability</h2>
                  <p>
                ...
                <section className={styles.section}>
                  ...
                  <p>
                    If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at travelfashionkorea@gmail.com.
                  </p>
                </section>
              </div>
            )}
